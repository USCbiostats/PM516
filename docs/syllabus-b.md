...
* Initial Meeting. Once the project is assigned, the student will schedule a meeting with the client (and instructor, if possible). After the meeting, the student must send the client and instructor a consultation follow-up e-mail that discusses the [scope of work](PM516b_SOW_Template.docx) and appropriate timelines for the project.
